...
var type = new _typed2.default('.typed', {
    strings: ['KUZNETCOV', 'DREAM', 'KUZNETCOV'],
    typeSpeed: 50,
    backSpeed: 40,
    smartBackspace: true,
    showCursor: false
...
var type_team = new _typed2.default('.typed-team', {
    strings: ['', '.TEAM'],
    typeSpeed: 50,
    backSpeed: 10,
    smartBackspace: true,
...
var containerHeight = void 0,
    getPositionContainer = void 0,
    windowHeight = void 0;
var container = document.querySelector('.container-indicators');

var coutn = false;

if (document.documentElement.clientWidth < 900) {
    var slider = new _swiper2.default(container, {
        speed: 100,
        direction: 'horizontal',
        spaceBetween: 0,
        loop: true,
